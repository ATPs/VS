...
#define _LSScore_ (scoreMatrix[(*pi)->rank][(*pj)->left->rank] - (*pj)->right->leaves)
#define _RSScore_ (scoreMatrix[(*pi)->rank][(*pj)->right->rank] - (*pj)->left->leaves)
#define _SLScore_ (scoreMatrix[(*pi)->left->rank][(*pj)->rank] - (*pi)->right->leaves)
#define _SRScore_ (scoreMatrix[(*pi)->right->rank][(*pj)->rank] - (*pi)->left->leaves)
